      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-pink-500 to-blue-500 hover:bg-slate-200 text-white"
            >
              Hire Me
            </Link>
            ...
            <a
              href="/cv.pdf"
              download
              className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-pink-500 to-blue-500 hover:bg-slate-800 text-white mt-3"
            >
